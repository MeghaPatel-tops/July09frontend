...
function Navbar() {
  return (
    <div>
        <nav className="relative bg-purple-400">
    ...
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex shrink-0 items-center">
            <label className='text-3xl font-extrabold text-white' >DesignM</label>
        </div>
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            <a href="#" aria-current="page" className="rounded-md bg-purple-900 px-3 py-2 text-sm font-medium text-white">Dashboard</a>
