      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            ...
            <NavLink to={'/'} className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Dashboard</NavLink>
            ...
            <NavLink to={'/service'} className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Service</NavLink>
            <NavLink to={'/product'} className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Product</NavLink>
